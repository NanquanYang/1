...
#   Outline:
#
#   1. Selection using loc (label based)#检测行和列
#     1.1 Series:
...
# x  = df.loc['2020-01-02',['Close','Bday']]
# print(x)
...
# print(type(df.loc['2020-01-03',:]))---<class 'pandas.core.series.Series'>
# print(type(df.loc[:,'Close']))---<class 'pandas.core.series.Series'>
# print(type(df.loc[:,['Close']]))---<class 'pandas.core.frame.DataFrame'>
# print(type(df.loc[['2020-01-02','2020-01-03'],'Close']))---<class 'pandas.core.series.Series'>
# print(type(df.loc['2020-01-01':'2020-01-10',:]))<class 'pandas.core.frame.DataFrame'>
# print(type(df.loc['2020-01-06':,:]))---<class 'pandas.core.frame.DataFrame'>
# print(type(df.loc['2020-01-06','Close':]))---<class 'pandas.core.series.Series'>
# ----------------------------------------------------------------------------
...
# x  = ser.loc['2020-01-02':'2020-01-06']
# print(x)
